...
public class GUICalc extends JFrame {
    ...
    public GUICalc() {
        label = new JLabel("CALCULATOR ", SwingConstants.CENTER);
        ...
        panel1.setBackground(new Color(146, 146, 146));
        ...
        b1.setBackground(new Color(85, 170, 170));

        panel.add(b1);
        b2.setBackground(new Color(85, 170, 170));
        panel.add(b2);
        b3.setBackground(new Color(85, 170, 170));
        panel.add(b3);
        clear.setBackground(new Color(85, 170, 170));
        panel.add(clear);
        b4.setBackground(new Color(85, 170, 170));
        panel.add(b4);
        b5.setBackground(new Color(85, 170, 170));
        panel.add(b5);
        b6.setBackground(new Color(85, 170, 170));
        panel.add(b6);
        plus.setBackground(new Color(85, 170, 170));
        panel.add(plus);
        b7.setBackground(new Color(85, 170, 170));
        panel.add(b7);
        b8.setBackground(new Color(85, 170, 170));
        panel.add(b8);
        b9.setBackground(new Color(85, 170, 170));
        panel.add(b9);
        minus.setBackground(new Color(85, 170, 170));
        panel.add(minus);
        decimalButton.setBackground(new Color(85, 170, 170));
        panel.add(decimalButton);
        b0.setBackground(new Color(85, 170, 170));
        panel.add(b0);
        div.setBackground(new Color(85, 170, 170));
        panel.add(div);
        mult.setBackground(new Color(85, 170, 170));
        panel.add(mult);
        reset.setBackground(new Color(85, 170, 170));
        panel.add(reset);
        pi.setBackground(new Color(85, 170, 170));
        panel.add(pi);
        sq.setBackground(new Color(85, 170, 170));
        panel.add(sq);
        equal.setBackground(new Color(85, 170, 170));
        panel.add(equal);
